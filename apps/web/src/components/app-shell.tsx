...
const NAV = [
  { href: "/app", label: "Floor", icon: "▣", roles: ["owner", "manager", "staff"] },
  { href: "/app/orders", label: "Tickets", icon: "☰", roles: ["owner", "manager", "staff"] },
  { href: "/kitchen", label: "Kitchen", icon: "♨", roles: ["owner", "manager", "staff", "kitchen"] },
  { href: "/app/menu", label: "Menu", icon: "▤", roles: ["owner", "manager"] },
  { href: "/app/tables", label: "Tables", icon: "▦", roles: ["owner", "manager"] },
  { href: "/app/reports", label: "Reports", icon: "▣", roles: ["owner", "manager"] },
  { href: "/app/staff", label: "Staff", icon: "☺", roles: ["owner"] },
  { href: "/app/settings", label: "Settings", icon: "⚙", roles: ["owner", "manager"] },
];
