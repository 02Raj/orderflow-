...
export default function GuestMenuPage() {
  ...
  if (error && !data) {
    return (
      <main className="mx-auto max-w-md px-5 py-16 text-center">
        <h1 className="display text-3xl">This table is not available</h1>
  ...
  if (placed) {
    return (
      <main className="mx-auto max-w-md px-5 py-16 text-center">
        <p className="text-xs font-semibold uppercase tracking-[0.14em] text-[var(--chili)]">
          Ticket sent
        </p>
        <h1 className="display mt-3 text-4xl">#{placed.orderNumber}</h1>
        <ol className="mx-auto mt-8 flex max-w-xs justify-between text-[11px] font-medium text-[var(--ink-soft)]">
        ...
        <p className="mt-6 text-[var(--ink-soft)]">
          Table {data.table.number}. Pay at the table as usual.
        </p>
  ...
  return (
    <main className="mx-auto max-w-lg pb-48">
      <header className="border-b border-[var(--rule)] px-5 py-7">
        <p className="text-xs font-semibold uppercase tracking-[0.14em] text-[var(--chili)]">
          Table {data.table.number}
        </p>
        <h1 className="display mt-2 text-3xl">{data.restaurant.name}</h1>
        <p className="mt-2 text-sm text-[var(--ink-soft)]">Tap a dish to add it. No account needed.</p>
